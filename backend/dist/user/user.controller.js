...
let UserController = class UserController {
    ...
    addList(user, productId) {
        return this.service.addList(user, productId);
    }
    deleteList(user, productId) {
...
__decorate([
    ...
    (0, common_1.Patch)('deleteList/:id'),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, auth_user_decorator_1.default)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "deleteList", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)()),
    (0, swagger_1.ApiOperation)({
        summary: 'Mostra os produtos do carrinho do usuário logado'
    }),
    (0, common_1.Get)('seeList/'),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, auth_user_decorator_1.default)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "cartList", null);
